...
​								public StringBuffer insert(int offset,String str):	注意索引越界异常
...
​								public StringBuffer deleteCharAt(int **index**):	注意索引越界异常
​									删除**指定位置**的字符，并返回本身	
...
private static void demo1() {
    ...
    System.out.println("快乐快乐:"+"快乐快乐".matches(regex1));		// 快快乐乐:false

    //叠词ABAB的正则
    System.out.println("叠词ABAB的正则");
    String regex2 = "(..)\\1";
    System.out.println("快快乐乐:"+"快快乐乐".matches(regex2));		// 快快乐乐:false
    System.out.println("快乐快乐:"+"快乐快乐".matches(regex2));		// 快快乐乐:true
}
